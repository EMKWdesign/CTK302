...
function setup() {
  ...
  bunnyImage = loadImage("assets/Waldo.png");
  imageMode(CENTER);
  rectMode(CENTER);
  myFont = loadFont("assets/OptimaExtraBlack.ttf");
}
...
function draw() {
  ...
  textFont('OptimaExtraBlack');
  fill(16, 177, 222);
  noStroke();
  textSize(100);
  textAlign(CENTER);
  text("WHERE'S", width / 2, height / 2);
  fill('red');
  text("WALDO?", width / 2, height / 2 + 100);
}
